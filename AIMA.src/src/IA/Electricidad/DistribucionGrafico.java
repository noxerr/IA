...
public class DistribucionGrafico extends javax.swing.JFrame {
    ...
    private void DistHillClimbingSearch(Distribucion dist) {
        ...
        try {
            ...
            Res.append("\n\nEstado final\n"+((Distribucion)search.getGoalState()).toString());
            Res.append("\nTiempo del Greedy\n  "+tiempoGreedy+" ms");
            Res.append("\nTiempo de ejecucion\n  "+tiempoEjecucion+" ms");
            Res.append("\nTiempo Total\n  "+(tiempoEjecucion+tiempoGreedy)+" ms");
            calcularValorSol((Distribucion)search.getGoalState());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setName("tabbed"); // NOI18N
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .add(jPanel14Layout.createSequentialGroup()
                .addContainerGap()
                .add(jScrollPane5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 728, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .add(jPanel15Layout.createSequentialGroup()
                ...
                .add(Bejecutar)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(bprogress, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(bExportar)
                .add(154, 154, 154))
        );
...
// TODO add your handling code here:
    ...
    private void  ejecutarBateria() {
        ...
        String heurist[] = {"Heurístico Ecológico\n ","Heurístico Ahorro\n ","Heurístico Eco-Ahorro\n ","Heurístico Eco-Ahorro-Benef\n "};
        String init[] = {"Sin inicialización\n "," Greedy Ecológico\n "," Greedy Ahorro\n "," Greedy Eco-Ahorro\n "," Greedy Eco-Ahorro-Benef\n "};
        
        bRes.append("Configuración\n\n");
        bRes.append("Nº Pruebas:"+bpruebs.getText()+" Nº Paquetes:"+bpaqs.getText()+" Nº Consumidores:"+bcons.getText()+"\n\n");
    ...
    private void DistBateriaHillClimbingSearch(int id,int nump, double r[],long t[],Distribucion dist,DistribucionHeuristic h) {
        try {
            ...
            r[id] += (double)(h.getHeuristicValue((Distribucion)search.getGoalState()))/(double)nump;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
// TODO add your handling code here:
    ...
    private void crearModelTablas() {
        ...
        model1 =  new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Compañía", "Precio", "CO2", "kWh", "Beneficio"
            }
        ) {
    ...
    private void calcularValorSol(Distribucion dist) {
        ...
        if( IniSin.isSelected()) {
            ...
            gre = "Ecológico y ahorro";
        }else{
            gre = "Ecológico, ahorro y beneficio";
       }
        
        Res.append("Inicialización utilizada: "+gre+"\n");
