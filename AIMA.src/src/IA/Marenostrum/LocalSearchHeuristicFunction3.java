...
public class LocalSearchHeuristicFunction3 implements HeuristicFunction  
{
  ...
  public double getHeuristicValue(Object state) 
  {
		...
		return (LSBoard.getProcsCount(1) * 5) + (LSBoard.getProcsCount(2) * 4) + (LSBoard.getProcsCount(3) * 3) + (LSBoard.getProcsCount(4) * 2) + (LSBoard.getProcsCount(5) * 1) + LSBoard.getIntervalosCount();
	}  
}
